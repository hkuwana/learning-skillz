...
- [Q21045424] Approximate Bayesian computation
- [Q182505] Bayes' theorem
- [Q4165283] Bayes factor
- [Q842217] Bayesian estimator
- [Q17100952] Bayesian hierarchical modeling
- [Q1988242] Bayesian information criterion
- [Q4874474] Bayesian linear regression
- [Q245652] Bayesian model averaging
- [Q812534] Bayesian probability
- [Q4874481] Bayesian statistics
- [Q4894580] Bernstein–von Mises theorem
- [Q715108] Coherence (philosophical gambling strategy)
- [Q3711784] Conjugate prior
- [Q1054106] Cox's theorem
- [Q4439221] Credible interval
- [Q5187655] Cromwell's rule
- [Q177571] Decision theory
- [Q5374241] Empirical Bayes method
- [Q55643021] Evidence lower bound
- [Q115806048] Integrated nested Laplace approximations
- [Q115806048] Laplace's approximation
- [Q45284] Likelihood function
- [Q13200161] Likelihood principle
- [Q6760420] Marginal likelihood
- [Q1191869] Markov chain Monte Carlo
- [Q745328] Mathematical statistics
- [Q635384] Maximum a posteriori estimation
- [Q17148751] Nested sampling algorithm
- [Q7234227] Posterior predictive distribution
- [Q278079] Posterior probability
- [Q1661371] Principle of indifference
- [Q1417473] Principle of maximum entropy
- [Q278090] Prior probability
- [Q195771] Sequential analysis
- [Q938438] Statistical inference
- [Q12483] Statistics
- [Q7915794] Variational Bayesian methods
...
- [Q45284] Likelihood function
- [Q7234227] Posterior predictive distribution
- [Q1192065] Point estimation
- [Q3711784] Conjugate prior
- [Q1188504] Exponential family
- [Q5051810] Categorical distribution
- [Q4894580] Bernstein–von Mises theorem
- [Q5280766] Dirichlet process
- [Q1275153] Expectation–maximization algorithm
- [Q4874474] Bayesian linear regression
- [Q4704939] Dirichlet-multinomial distribution
...
, a data point in general.  This may be a vector of values.
...
The posterior distribution is the distribution of the parameter(s) after taking into account the observed data.  This is determined by Bayes' rule, which forms the heart of Bayesian inference:
    ...
    {\displaystyle p(\theta \mid \mathbf {X} ,\alpha )={\frac {p(\theta ,\mathbf {X} ,\alpha )}{p(\mathbf {X} ,\alpha )}}={\frac {p(\mathbf {X} \mid \theta ,\alpha )p(\theta ,\alpha )}{p(\mathbf {X} \mid \alpha )p(\alpha )}}}
    ...
    {\displaystyle ={\frac {p(\mathbf {X} \mid \theta ,\alpha )p(\theta \mid \alpha )}{p(\mathbf {X} \mid \alpha )}}\propto p(\mathbf {X} \mid \theta ,\alpha )p(\theta \mid \alpha ).}
...
Taking a value with the greatest probability defines the maximum a posteriori estimation (MAP):
...
The posterior predictive distribution of a new observation 
 ...
 (that is independent of previous observations) is determined by
    ...
    {\displaystyle p({\tilde {x}}|\mathbf {X} ,\alpha )=\int p({\tilde {x}},\theta \mid \mathbf {X} ,\alpha )\,d\theta }
    ...
    {\displaystyle =\int p({\tilde {x}}\mid \theta )p(\theta \mid \mathbf {X} ,\alpha )\,d\theta .}
...
The event 
 ...
 is the observation of a plain cookie. From the contents of the bowls, it is known that 
 ...
 Bayes' formula then yields
    ...
    {\displaystyle P(H_{1}\mid E)={\frac {P(E\mid H_{1})\,P(H_{1})}{P(E\mid H_{1})\,P(H_{1})\;+\;P(E\mid H_{2})\,P(H_{2})}}}
    ...
    {\displaystyle ={\frac {0.75\times 0.5}{0.75\times 0.5+0.5\times 0.5}}=0.6}
  

Before Fred's cookie is observed, the probability of Fred having chosen bowl #1 was the prior probability 
    ...
    {\displaystyle P(H_{1})=50\%.}
  
 By acknowledging the cookie, Fred's (any observer's) better-informed estimate of 
...
The degree of belief in the continuous variable 
 ...
 as evidence. The information from the previous paragraph yields
    ...
    {\displaystyle p_{G}(c)=0.01+{\frac {0.80}{5}}(c-11)}
  

for the glaze probability and
    ...
    {\displaystyle p_{D}(c)=0.5-{\frac {0.45}{5}}(c-11)}
  

for the decoration probability; their complements being
    ...
    {\displaystyle {\bar {p}}_{G}(c)=1-p_{G}(c),\quad {\bar {p}}_{D}(c)=1-p_{D}(c).}
  

Assuming linear variation of glaze and decoration with time and that these variables are independent, the probability of each event reads
...
When a new fragment of type 
 ...
 is discovered, that means more information for the investigation and, through Bayes' theorem, an updated Bayesian inference towards an improved degree of belief (or confidence) in the archeologists' estimation. Assuming a uniform prior of 
...
, and that trials are independent and identically distributed,
    ...
    {\displaystyle f_{C}(c\mid E=e)={\frac {P(E=e\mid C=c)}{P(E=e)}}f_{C}(c)}
    ...
    {\displaystyle ={\frac {P(E=e\mid C=c)}{\int _{11}^{16}{P(E=e\mid C=c)f_{C}(c)dc}}}f_{C}(c).}
...
In cosmology, it is often employed with computational techniques such as Markov chain Monte Carlo(MCMC) and Nested sampling algorithm to analyse complex datasets and navigate high-dimensional parameter space. A notable application is to the Planck 2018 CMB data for parameter inference.
...
Stone, JV (2013), "Bayes' Rule: A Tutorial Introduction to Bayesian Analysis",   "Download first  chapter here". Archived from the original on 2015-07-22., Sebtel Press, England.
...
"Introduction to Bayesian probability". Archived from the original on 2009-05-04. from Queen Mary University of London
"Mathematical Notes on Bayesian Statistics and Markov Chain Monte Carlo". Archived from the original on 2016-03-04.
"Bayesian reading list". Archived from the original on 2011-06-25., categorized and annotated by Tom Griffiths
